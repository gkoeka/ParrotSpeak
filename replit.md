...
- ✓ **Enhanced Password Security Requirements (July 15, 2025)**: **SECURITY STRENGTHENED** - Implemented stronger password requirements across all platforms: 8+ characters with letters, numbers, and at least one special character. Created friendly UX with visual requirement lists in registration and password change forms. Cross-platform validation consistency maintained using shared validation utility.

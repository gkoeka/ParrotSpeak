// CommonJS-specific configuration for Node.js compatibility
// This ensures proper CommonJS exports for direct Node.js usage

// Environment configuration with proper CommonJS fallback logic
...
// Also export as individual properties
